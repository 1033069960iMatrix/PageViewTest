...
public class PageViewHeader extends FrameLayout {
    ...
    public PageViewHeader(Context context) {
        this(context, null);
    }

    public PageViewHeader(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PageViewHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public PageViewHeader(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mLightDismissDrawable = res.getDrawable(R.drawable.page_view_dismiss_light);
        mDarkDismissDrawable = res.getDrawable(R.drawable.page_view_dismiss_dark);
        ...
        if (sHighlightPaint == null) {
            ...
            sHighlightPaint.setStrokeWidth(mConfig.pageViewHighlightPx);
    ...
    protected void onFinishInflate() {
        ...
        mBackgroundColorDrawable = (GradientDrawable) getContext().getDrawable(R.drawable
                .page_view_header_bg_color);
        // Copy the ripple drawable since we are going to be manipulating it
        mBackground = (RippleDrawable)
                getContext().getDrawable(R.drawable.page_view_header_bg);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float offset = (float) Math.ceil(mConfig.pageViewHighlightPx / 2f);
        float radius = mConfig.pageViewRoundedCornerRadiusPx;
...
/*    void startLaunchTaskDismissAnimation() {
        if (mDismissButton.getVisibility() == View.VISIBLE) {
            ...
            mDismissButton.animate()
                    ...
                    .setDuration(mConfig.pageViewExitToAppDuration)
                    .withLayer()
                    .start();
        }
    }*/
    ...
    void startNoUserInteractionAnimation() {
        if (mDismissButton.getVisibility() != View.VISIBLE) {
            ...
            mDismissButton.animate()
                    ...
                    .setDuration(mConfig.pageViewEnterFromAppDuration)
                    .withLayer()
                    .start();
        }
    }
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        ...
        // Don't forward our state to the drawable - we do it manually in onpageViewFocusChanged.
