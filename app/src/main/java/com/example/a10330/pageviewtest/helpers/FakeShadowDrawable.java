...
public class FakeShadowDrawable extends Drawable {
    ...
    public FakeShadowDrawable(Resources resources, PageStackViewConfig config) {
        ...
        mCornerRadius = config.pageViewRoundedCornerRadiusPx;
    ...
    void setShadowSize(float shadowSize, float maxShadowSize) {
        ...
        if (shadowSize > maxShadowSize) {
            ...
            if (!mPrintedShadowClipWarning) {
                Log.w("PageView", "Shadow size is being clipped by the max shadow size. See "
                        + "{PageView#setMaxCardElevation}.");
